/*
 * USB descriptors for the UAC1 speaker-only build.
 */
...
uint8_t const desc_configuration[] =
{
    ...
    // UAC1 speaker-only descriptor: host OUT -> Pico -> Bluetooth.
    0x08, 0x0B, ITF_NUM_AUDIO_CONTROL, ITF_NUM_TOTAL, 0x01, 0x00, 0x00, 0x02,
